...
const steps = [
  {
    selector: "body",
    content:
      "¡Bienvenido a la sección de asistencias! Aquí puedes ver el resumen de asistencia de los empleados.",
  },
  {
    selector: ".attendance-search",
    content:
      "Puedes buscar empleados por nombre o apellido por medio de esta barra de búsqueda.",
  },
  {
    selector: ".attendance-filter",
    content: "Tambien puedes utilizar filtros para facilitar tu búsqueda.",
  },
  {
    selector: ".attendance-table",
    content:
      "Aquí tienes una tabla con los datos de las asistencias filtradas.",
  },
  {
    selector: "tbody tr:first-child td:last-child button",
    content:
      "Haz clic en 'Ver' para ver los detalles de las fichadas de un empleado y gestionarlas.",
  },
  {
    selector: ".help-tour-btn",
    content:
      "Si necesitas ver esta guía nuevamente, no dudes en hacer clic en este botón.",
  },
  {
    selector: "body",
    content: "¡Listo! Ya puedes usar el resumen de asistencia.",
    position: "center",
  },
];

function AttendanceEmployeeChecksTableContent(props) {
  ...
  React.useEffect(() => {
    const alreadySeen = localStorage.getItem("seenAttendanceTour");
    if (!alreadySeen) {
      setCurrentStep(0);
      setIsOpen(true);
      localStorage.setItem("seenAttendanceTour", "true");
    }
    ...
    <div className="p-6">
      <div className="flex flex-wrap gap-2 justify-between items-center mb-4">
        <div className="flex gap-2 items-center">
          <h1 className="attendance-title text-2xl font-semibold">
        ...
        <input
          ...
          className="attendance-search px-4 py-2 border border-gray-300 rounded-full w-80 focus:outline-none focus:ring-2 focus:ring-emerald-500"
      ...
      <div className="overflow-x-auto max-h-[70vh] overflow-y-auto rounded-lg">
        <table className="attendance-table min-w-full bg-white text-xs">
...
export default function AttendanceEmployeeChecksTable() {
  ...
  return (
    <AppTourProvider steps={steps}>
      <AttendanceEmployeeChecksTableContent
        ...
        fetchAttendanceResume={fetchAttendanceResume}
      />
    </AppTourProvider>
  );
}
